...
namespace Logiciel_de_gestion_de_cave_a_vin.Models
{
    class GestionBouteille
    {
        ...
        public static Dictionary<string, Image> ChargerImage()
        {
            ...
            {
                { "Rouge", Image.FromFile(@"C:\Users\lenny\Desktop\Vins-main\Logiciel de gestion de cave a vin\images\rouge.png") },
                { "Blanc", Image.FromFile(@"C:\Users\lenny\Desktop\Vins-main\Logiciel de gestion de cave a vin\images\blanc.png") },
                { "Rosé", Image.FromFile(@"C:\Users\lenny\Desktop\Vins-main\Logiciel de gestion de cave a vin\images\rose.png") }
            };
